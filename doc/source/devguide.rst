...
This section explains the basics for developers who are contributing
to the XBrainMap project.
...
on `GitHub <https://github.com>`_ and fork the XBrainMap repository by 
clicking the **Fork** button in the header of the 
`XBrainMap repository <https://github.com/xbrainmap/xbrainmap>`__: 
...
then you should consider contributing back to the XbrainMap project. For this, 
...
between your forked branch and the original XbrainMap repository. 
