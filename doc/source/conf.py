# -*- coding: utf-8 -*-
#
# xbrainmap documentation build configuration file, created by
...
htmlhelp_basename = 'xbrainmapdoc'
...
texinfo_documents = [
  (master_doc, 'xbrainmap', u'xbrainmap Documentation',
   argonne, 'xbrainmap', 'One line description of project.',
   'Miscellaneous'),
]
